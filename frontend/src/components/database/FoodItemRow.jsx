    ...
    return (
        ...
        >
            <div className="flex-1 min-w-0 pr-3">
                <span className="font-sans text-sm font-medium text-primary block truncate">{item.name}</span>
                {item.quantity && (
            ...
            <div className="text-right shrink-0">
                <span className="type-value text-sm">{Math.round(item.calories || 0)}</span>
